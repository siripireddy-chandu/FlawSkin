...
const url = 'https://script.google.com/macros/s/AKfycbzucBDFJYeUCtsM-a0yS1c3wz_tYXP9lc06ZnZ1ecvbAHmOdOQjCVypth2MxUZYZAW5gA/exec';

document.addEventListener('DOMContentLoaded', () => {
    const resheduleform = document.forms['reshedule-form'];
...
// Validate date
const dateTime = resheduleform.elements['Date Time'].value;
...
// If validation passes, submit the form
        fetch(url, { method: 'POST', body: new FormData(resheduleform) })
            .then(response => {
